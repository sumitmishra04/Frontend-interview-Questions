...
Temporal Dead Zone (TDZ) is the period between the start of a block and the point where a variable is declared. 
During this time, accessing the variable will throw a ReferenceError.
The variable exists
👉 But it is unusable
👉 Any access throws a ReferenceError
