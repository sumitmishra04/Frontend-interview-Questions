 ...
 */
var _currentAuthState = _objectSpread(_objectSpread({}, initialState), {}, {
...
export function AuthProvider(_ref) {
  ...
  var login = function login(user, accessToken) {
    dispatch({
      type: 'LOGIN',
      payload: {
        user: user,
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          ...
          case 2:
            _context.p = 2;
            _t = _context.v;
            console.warn('Logout API failed (possibly already expired token):', _t);
          case 3:
            // ✅ Clear client state
            dispatch({
              type: 'LOGOUT'
  ...
  _currentAuthState = _objectSpread(_objectSpread({}, state), {}, {
    login: login,
    logout: logout
  });
