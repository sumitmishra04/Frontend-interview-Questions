...
// Approach: ensure total gas is more than total cost. else exit. then start with index 0 and keep adding the gas cost as we move on if cost goes below 0 then update startindex to i+1 and set lastGas to 0
